...
module fast_shock
  ...
  implicit none
  private
  public makefastshock
  !
contains
  !
  subroutine makefastshock(CCTK_ARGUMENTS,i,j,k)
    ...
    uu4(3) = maxvel*(13.0455)
    uu4(2) = maxvel*(0.19615)
    uu4(1) = 0.0
  ...
  end subroutine makefastshock
  !
end module fast_shock
