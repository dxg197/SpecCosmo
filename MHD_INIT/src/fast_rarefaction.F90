...
module fast_rarefaction
  ...
  implicit none
  private
  public makefastrarefaction
  !
contains
  !
  subroutine makefastrarefaction(CCTK_ARGUMENTS,i,j,k)
  ...
  end subroutine makefastrarefaction
  !
end module fast_rarefaction
