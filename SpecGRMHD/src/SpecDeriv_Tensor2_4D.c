...
void SpecDeriv_Tensor_Derivative2_4D( CCTK_ARGUMENTS, CCTK_REAL *****tensor2_4D );
void SpecDeriv_Write_Tensor2_4D( CCTK_ARGUMENTS, CCTK_REAL *****tensor2_4D );
void SpecDeriv_SpecGalMethod_Tensor2_4D( CCTK_ARGUMENTS );
...
void SpecDeriv_Tensor_Derivative2_4D( CCTK_ARGUMENTS, CCTK_REAL *****tensor2_4D )
{
	...
	SpecDeriv_SpecGalMethod_Tensor2_4D( CCTK_PASS_CTOC );
	SpecDeriv_Write_Tensor2_4D( CCTK_PASS_CTOC, tensor2_4D );
}
...
void SpecDeriv_SpecGalMethod_Tensor2_4D( CCTK_ARGUMENTS )
{
    ...
    fftw_plan plan_backward11tt;
    fftw_plan plan_backward22tt;
    fftw_plan plan_backward33tt;
    fftw_plan plan_backward11tx;
    fftw_plan plan_backward22tx;
    fftw_plan plan_backward33tx;
    fftw_plan plan_backward11ty;
    fftw_plan plan_backward22ty;
    fftw_plan plan_backward33ty;
    fftw_plan plan_backward11tz;
    fftw_plan plan_backward22tz;
    fftw_plan plan_backward33tz;
    fftw_plan plan_backward12tt;
    fftw_plan plan_backward13tt;
    fftw_plan plan_backward23tt;
    fftw_plan plan_backward12tx;
    fftw_plan plan_backward13tx;
    fftw_plan plan_backward23tx;
    fftw_plan plan_backward12ty;
    fftw_plan plan_backward13ty;
    fftw_plan plan_backward23ty;
    fftw_plan plan_backward12tz;
    fftw_plan plan_backward13tz;
    fftw_plan plan_backward23tz;
    ...
    fftw_complex *Derivative_SGM11tt, *Derivative_SGM12tt;
    fftw_complex *Derivative_SGM22tt, *Derivative_SGM13tt;
    fftw_complex *Derivative_SGM33tt, *Derivative_SGM23tt;
    fftw_complex *Derivative_SGM11tx, *Derivative_SGM12tx;
    fftw_complex *Derivative_SGM22tx, *Derivative_SGM13tx;
    fftw_complex *Derivative_SGM33tx, *Derivative_SGM23tx;
    fftw_complex *Derivative_SGM11ty, *Derivative_SGM12ty;
    fftw_complex *Derivative_SGM22ty, *Derivative_SGM13ty;
    fftw_complex *Derivative_SGM33ty, *Derivative_SGM23ty;
    fftw_complex *Derivative_SGM11tz, *Derivative_SGM12tz;
    fftw_complex *Derivative_SGM22tz, *Derivative_SGM13tz;
    fftw_complex *Derivative_SGM33tz, *Derivative_SGM23tz;
    ...
    fftw_complex *Derivative_SGM11tt_out, *Derivative_SGM12tt_out;
    fftw_complex *Derivative_SGM22tt_out, *Derivative_SGM13tt_out;
    fftw_complex *Derivative_SGM33tt_out, *Derivative_SGM23tt_out;
    fftw_complex *Derivative_SGM11tx_out, *Derivative_SGM12tx_out;
    fftw_complex *Derivative_SGM22tx_out, *Derivative_SGM13tx_out;
    fftw_complex *Derivative_SGM33tx_out, *Derivative_SGM23tx_out;
    fftw_complex *Derivative_SGM11ty_out, *Derivative_SGM12ty_out;
    fftw_complex *Derivative_SGM22ty_out, *Derivative_SGM13ty_out;
    fftw_complex *Derivative_SGM33ty_out, *Derivative_SGM23ty_out;
    fftw_complex *Derivative_SGM11tz_out, *Derivative_SGM12tz_out;
    fftw_complex *Derivative_SGM22tz_out, *Derivative_SGM13tz_out;
    fftw_complex *Derivative_SGM33tz_out, *Derivative_SGM23tz_out;
    ...
    Derivative_SGM11tt = fftw_alloc_complex(alloc_local);
    Derivative_SGM22tt = fftw_alloc_complex(alloc_local);
    Derivative_SGM33tt = fftw_alloc_complex(alloc_local);
    Derivative_SGM11tx = fftw_alloc_complex(alloc_local);
    Derivative_SGM22tx = fftw_alloc_complex(alloc_local);
    Derivative_SGM33tx = fftw_alloc_complex(alloc_local);
    Derivative_SGM11ty = fftw_alloc_complex(alloc_local);
    Derivative_SGM22ty = fftw_alloc_complex(alloc_local);
    Derivative_SGM33ty = fftw_alloc_complex(alloc_local);
    Derivative_SGM11tz = fftw_alloc_complex(alloc_local);
    Derivative_SGM22tz = fftw_alloc_complex(alloc_local);
    Derivative_SGM33tz = fftw_alloc_complex(alloc_local);
    Derivative_SGM12tt = fftw_alloc_complex(alloc_local);
    Derivative_SGM13tt = fftw_alloc_complex(alloc_local);
    Derivative_SGM23tt = fftw_alloc_complex(alloc_local);
    Derivative_SGM12tx = fftw_alloc_complex(alloc_local);
    Derivative_SGM13tx = fftw_alloc_complex(alloc_local);
    Derivative_SGM23tx = fftw_alloc_complex(alloc_local);
    Derivative_SGM12ty = fftw_alloc_complex(alloc_local);
    Derivative_SGM13ty = fftw_alloc_complex(alloc_local);
    Derivative_SGM23ty = fftw_alloc_complex(alloc_local);
    Derivative_SGM12tz = fftw_alloc_complex(alloc_local);
    Derivative_SGM13tz = fftw_alloc_complex(alloc_local);
    Derivative_SGM23tz = fftw_alloc_complex(alloc_local);
    ...
    Derivative_SGM11tt_out = fftw_alloc_complex(alloc_local);
    Derivative_SGM22tt_out = fftw_alloc_complex(alloc_local);
    Derivative_SGM33tt_out = fftw_alloc_complex(alloc_local);
    Derivative_SGM11tx_out = fftw_alloc_complex(alloc_local);
    Derivative_SGM22tx_out = fftw_alloc_complex(alloc_local);
    Derivative_SGM33tx_out = fftw_alloc_complex(alloc_local);
    Derivative_SGM11ty_out = fftw_alloc_complex(alloc_local);
    Derivative_SGM22ty_out = fftw_alloc_complex(alloc_local);
    Derivative_SGM33ty_out = fftw_alloc_complex(alloc_local);
    Derivative_SGM11tz_out = fftw_alloc_complex(alloc_local);
    Derivative_SGM22tz_out = fftw_alloc_complex(alloc_local);
    Derivative_SGM33tz_out = fftw_alloc_complex(alloc_local);
    Derivative_SGM12tt_out = fftw_alloc_complex(alloc_local);
    Derivative_SGM13tt_out = fftw_alloc_complex(alloc_local);
    Derivative_SGM23tt_out = fftw_alloc_complex(alloc_local);
    Derivative_SGM12tx_out = fftw_alloc_complex(alloc_local);
    Derivative_SGM13tx_out = fftw_alloc_complex(alloc_local);
    Derivative_SGM23tx_out = fftw_alloc_complex(alloc_local);
    Derivative_SGM12ty_out = fftw_alloc_complex(alloc_local);
    Derivative_SGM13ty_out = fftw_alloc_complex(alloc_local);
    Derivative_SGM23ty_out = fftw_alloc_complex(alloc_local);
    Derivative_SGM12tz_out = fftw_alloc_complex(alloc_local);
    Derivative_SGM13tz_out = fftw_alloc_complex(alloc_local);
    Derivative_SGM23tz_out = fftw_alloc_complex(alloc_local);
    ...
    for(k = 0; k < local_n0; k++) 
    {
        for(j = 0; j < sizey; j++) 
        {
            for(i = 0; i < sizex; i++) 
            {
                ...
                Derivative_SGM11tt[i + j*sizex + k*sizex*sizey] = -1.0 
                                            * Fourier_3D_kwaveN1 
                                            * Fourier_3D_kwaveN1 
                                            * phi_outtt[i + j*sizex + k*sizex*sizey]; 
                Derivative_SGM22tt[i + j*sizex + k*sizex*sizey] = -1.0 
                                            * Fourier_3D_kwaveN2 
                                            * Fourier_3D_kwaveN2 
                                            * phi_outtt[i + j*sizex + k*sizex*sizey];
                Derivative_SGM33tt[i + j*sizex + k*sizex*sizey] = -1.0 
                                            * Fourier_3D_kwaveN3 
                                            * Fourier_3D_kwaveN3 
                                            * phi_outtt[i + j*sizex + k*sizex*sizey];
                Derivative_SGM11tx[i + j*sizex + k*sizex*sizey] = -1.0 
                                            * Fourier_3D_kwaveN1
                                            * Fourier_3D_kwaveN1 
                                            * phi_outtx[i + j*sizex + k*sizex*sizey]; 
                Derivative_SGM22tx[i + j*sizex + k*sizex*sizey] = -1.0 
                                            * Fourier_3D_kwaveN2 
                                            * Fourier_3D_kwaveN2 
                                            * phi_outtx[i + j*sizex + k*sizex*sizey];
                Derivative_SGM33tx[i + j*sizex + k*sizex*sizey] = -1.0 
                                            * Fourier_3D_kwaveN3 
                                            * Fourier_3D_kwaveN3 
                                            * phi_outtx[i + j*sizex + k*sizex*sizey];
                Derivative_SGM11ty[i + j*sizex + k*sizex*sizey] = -1.0 
                                            * Fourier_3D_kwaveN1 
                                            * Fourier_3D_kwaveN1 
                                            * phi_outty[i + j*sizex + k*sizex*sizey]; 
                Derivative_SGM22ty[i + j*sizex + k*sizex*sizey] = -1.0 
                                            * Fourier_3D_kwaveN2 
                                            * Fourier_3D_kwaveN2 
                                            * phi_outty[i + j*sizex + k*sizex*sizey];
                Derivative_SGM33ty[i + j*sizex + k*sizex*sizey] = -1.0 
                                            * Fourier_3D_kwaveN3
                                            * Fourier_3D_kwaveN3 
                                            * phi_outty[i + j*sizex + k*sizex*sizey];
                Derivative_SGM11tz[i + j*sizex + k*sizex*sizey] = -1.0 
                                            * Fourier_3D_kwaveN1 
                                            * Fourier_3D_kwaveN1 
                                            * phi_outtz[i + j*sizex + k*sizex*sizey]; 
                Derivative_SGM22tz[i + j*sizex + k*sizex*sizey] = -1.0 
                                            * Fourier_3D_kwaveN2 
                                            * Fourier_3D_kwaveN2 
                                            * phi_outtz[i + j*sizex + k*sizex*sizey];
                Derivative_SGM33tz[i + j*sizex + k*sizex*sizey] = -1.0 
                                            * Fourier_3D_kwaveN3 
                                            * Fourier_3D_kwaveN3 
                                            * phi_outtz[i + j*sizex + k*sizex*sizey];
                Derivative_SGM12tt[i + j*sizex + k*sizex*sizey] = -1.0 
                                            * Fourier_3D_kwaveN1 
                                            * Fourier_3D_kwaveN2 
                                            * phi_outtt[i + j*sizex + k*sizex*sizey]; 
                Derivative_SGM13tt[i + j*sizex + k*sizex*sizey] = -1.0 
                                            * Fourier_3D_kwaveN1 
                                            * Fourier_3D_kwaveN3 
                                            * phi_outtt[i + j*sizex + k*sizex*sizey];
                Derivative_SGM23tt[i + j*sizex + k*sizex*sizey] = -1.0 
                                            * Fourier_3D_kwaveN2 
                                            * Fourier_3D_kwaveN3 
                                            * phi_outtt[i + j*sizex + k*sizex*sizey];
                Derivative_SGM12tx[i + j*sizex + k*sizex*sizey] = -1.0 
                                            * Fourier_3D_kwaveN1 
                                            * Fourier_3D_kwaveN2 
                                            * phi_outtx[i + j*sizex + k*sizex*sizey]; 
                Derivative_SGM13tx[i + j*sizex + k*sizex*sizey] = -1.0 
                                            * Fourier_3D_kwaveN1 
                                            * Fourier_3D_kwaveN3 
                                            * phi_outtx[i + j*sizex + k*sizex*sizey];
                Derivative_SGM23tx[i + j*sizex + k*sizex*sizey] = -1.0 
                                            * Fourier_3D_kwaveN2 
                                            * Fourier_3D_kwaveN3 
                                            * phi_outtx[i + j*sizex + k*sizex*sizey];
                Derivative_SGM12ty[i + j*sizex + k*sizex*sizey] = -1.0 
                                            * Fourier_3D_kwaveN1 
                                            * Fourier_3D_kwaveN2 
                                            * phi_outty[i + j*sizex + k*sizex*sizey]; 
                Derivative_SGM13ty[i + j*sizex + k*sizex*sizey] = -1.0 
                                            * Fourier_3D_kwaveN1 
                                            * Fourier_3D_kwaveN3 
                                            * phi_outty[i + j*sizex + k*sizex*sizey];
                Derivative_SGM23ty[i + j*sizex + k*sizex*sizey] = -1.0 
                                            * Fourier_3D_kwaveN2
                                            * Fourier_3D_kwaveN3  
                                            * phi_outty[i + j*sizex + k*sizex*sizey];
                Derivative_SGM12tz[i + j*sizex + k*sizex*sizey] = -1.0 
                                            * Fourier_3D_kwaveN1 
                                            * Fourier_3D_kwaveN2 
                                            * phi_outtz[i + j*sizex + k*sizex*sizey]; 
                Derivative_SGM13tz[i + j*sizex + k*sizex*sizey] = -1.0 
                                            * Fourier_3D_kwaveN1 
                                            * Fourier_3D_kwaveN3 
                                            * phi_outtz[i + j*sizex + k*sizex*sizey];
                Derivative_SGM23tz[i + j*sizex + k*sizex*sizey] = -1.0 
                                            * Fourier_3D_kwaveN2 
                                            * Fourier_3D_kwaveN3 
                                            * phi_outtz[i + j*sizex + k*sizex*sizey];
                ...
                Derivative_SGM11tt_out[i + j*sizex + k*sizex*sizey] = ZERO_COMPLEXNO; 
                Derivative_SGM12tt_out[i + j*sizex + k*sizex*sizey] = ZERO_COMPLEXNO;
                Derivative_SGM13tt_out[i + j*sizex + k*sizex*sizey] = ZERO_COMPLEXNO;
                Derivative_SGM11tx_out[i + j*sizex + k*sizex*sizey] = ZERO_COMPLEXNO; 
                Derivative_SGM12tx_out[i + j*sizex + k*sizex*sizey] = ZERO_COMPLEXNO;
                Derivative_SGM13tx_out[i + j*sizex + k*sizex*sizey] = ZERO_COMPLEXNO;
                Derivative_SGM11ty_out[i + j*sizex + k*sizex*sizey] = ZERO_COMPLEXNO; 
                Derivative_SGM12ty_out[i + j*sizex + k*sizex*sizey] = ZERO_COMPLEXNO;
                Derivative_SGM13ty_out[i + j*sizex + k*sizex*sizey] = ZERO_COMPLEXNO;
                Derivative_SGM11tz_out[i + j*sizex + k*sizex*sizey] = ZERO_COMPLEXNO; 
                Derivative_SGM12tz_out[i + j*sizex + k*sizex*sizey] = ZERO_COMPLEXNO;
                Derivative_SGM13tz_out[i + j*sizex + k*sizex*sizey] = ZERO_COMPLEXNO;
                ...
                Derivative_SGM22tt_out[i + j*sizex + k*sizex*sizey] = ZERO_COMPLEXNO;
                Derivative_SGM23tt_out[i + j*sizex + k*sizex*sizey] = ZERO_COMPLEXNO;
                Derivative_SGM22tx_out[i + j*sizex + k*sizex*sizey] = ZERO_COMPLEXNO;
                Derivative_SGM23tx_out[i + j*sizex + k*sizex*sizey] = ZERO_COMPLEXNO;
                Derivative_SGM22ty_out[i + j*sizex + k*sizex*sizey] = ZERO_COMPLEXNO;
                Derivative_SGM23ty_out[i + j*sizex + k*sizex*sizey] = ZERO_COMPLEXNO;
                Derivative_SGM22tz_out[i + j*sizex + k*sizex*sizey] = ZERO_COMPLEXNO;
                Derivative_SGM23tz_out[i + j*sizex + k*sizex*sizey] = ZERO_COMPLEXNO;
                ...
                Derivative_SGM33tt_out[i + j*sizex + k*sizex*sizey] = ZERO_COMPLEXNO;
                Derivative_SGM33tx_out[i + j*sizex + k*sizex*sizey] = ZERO_COMPLEXNO;
                Derivative_SGM33ty_out[i + j*sizex + k*sizex*sizey] = ZERO_COMPLEXNO;
                Derivative_SGM33tz_out[i + j*sizex + k*sizex*sizey] = ZERO_COMPLEXNO;
    ...
    plan_backward11tt = fftw_mpi_plan_dft_3d(sizex,sizey,sizez,Derivative_SGM11tt,Derivative_SGM11tt_out,MPI_COMM_WORLD,FFTW_BACKWARD,FFTW_WISDOM_ONLY | FFTW_ESTIMATE);
    plan_backward22tt = fftw_mpi_plan_dft_3d(sizex,sizey,sizez,Derivative_SGM22tt,Derivative_SGM22tt_out,MPI_COMM_WORLD,FFTW_BACKWARD,FFTW_WISDOM_ONLY | FFTW_ESTIMATE);
    plan_backward33tt = fftw_mpi_plan_dft_3d(sizex,sizey,sizez,Derivative_SGM33tt,Derivative_SGM33tt_out,MPI_COMM_WORLD,FFTW_BACKWARD,FFTW_WISDOM_ONLY | FFTW_ESTIMATE);
    plan_backward11tx = fftw_mpi_plan_dft_3d(sizex,sizey,sizez,Derivative_SGM11tx,Derivative_SGM11tx_out,MPI_COMM_WORLD,FFTW_BACKWARD,FFTW_WISDOM_ONLY | FFTW_ESTIMATE);
    plan_backward22tx = fftw_mpi_plan_dft_3d(sizex,sizey,sizez,Derivative_SGM22tx,Derivative_SGM22tx_out,MPI_COMM_WORLD,FFTW_BACKWARD,FFTW_WISDOM_ONLY | FFTW_ESTIMATE);
    plan_backward33tx = fftw_mpi_plan_dft_3d(sizex,sizey,sizez,Derivative_SGM33tx,Derivative_SGM33tx_out,MPI_COMM_WORLD,FFTW_BACKWARD,FFTW_WISDOM_ONLY | FFTW_ESTIMATE);
    plan_backward11ty = fftw_mpi_plan_dft_3d(sizex,sizey,sizez,Derivative_SGM11ty,Derivative_SGM11ty_out,MPI_COMM_WORLD,FFTW_BACKWARD,FFTW_WISDOM_ONLY | FFTW_ESTIMATE);
    plan_backward22ty = fftw_mpi_plan_dft_3d(sizex,sizey,sizez,Derivative_SGM22ty,Derivative_SGM22ty_out,MPI_COMM_WORLD,FFTW_BACKWARD,FFTW_WISDOM_ONLY | FFTW_ESTIMATE);
    plan_backward33ty = fftw_mpi_plan_dft_3d(sizex,sizey,sizez,Derivative_SGM33ty,Derivative_SGM33ty_out,MPI_COMM_WORLD,FFTW_BACKWARD,FFTW_WISDOM_ONLY | FFTW_ESTIMATE);
    plan_backward11tz = fftw_mpi_plan_dft_3d(sizex,sizey,sizez,Derivative_SGM11tz,Derivative_SGM11tz_out,MPI_COMM_WORLD,FFTW_BACKWARD,FFTW_WISDOM_ONLY | FFTW_ESTIMATE);
    plan_backward22tz = fftw_mpi_plan_dft_3d(sizex,sizey,sizez,Derivative_SGM22tz,Derivative_SGM22tz_out,MPI_COMM_WORLD,FFTW_BACKWARD,FFTW_WISDOM_ONLY | FFTW_ESTIMATE);
    plan_backward33tz = fftw_mpi_plan_dft_3d(sizex,sizey,sizez,Derivative_SGM33tz,Derivative_SGM33tz_out,MPI_COMM_WORLD,FFTW_BACKWARD,FFTW_WISDOM_ONLY | FFTW_ESTIMATE);
    plan_backward12tt = fftw_mpi_plan_dft_3d(sizex,sizey,sizez,Derivative_SGM12tt,Derivative_SGM12tt_out,MPI_COMM_WORLD,FFTW_BACKWARD,FFTW_WISDOM_ONLY | FFTW_ESTIMATE);
    plan_backward13tt = fftw_mpi_plan_dft_3d(sizex,sizey,sizez,Derivative_SGM13tt,Derivative_SGM13tt_out,MPI_COMM_WORLD,FFTW_BACKWARD,FFTW_WISDOM_ONLY | FFTW_ESTIMATE);
    plan_backward23tt = fftw_mpi_plan_dft_3d(sizex,sizey,sizez,Derivative_SGM23tt,Derivative_SGM23tt_out,MPI_COMM_WORLD,FFTW_BACKWARD,FFTW_WISDOM_ONLY | FFTW_ESTIMATE);
    plan_backward12tx = fftw_mpi_plan_dft_3d(sizex,sizey,sizez,Derivative_SGM12tx,Derivative_SGM12tx_out,MPI_COMM_WORLD,FFTW_BACKWARD,FFTW_WISDOM_ONLY | FFTW_ESTIMATE);
    plan_backward13tx = fftw_mpi_plan_dft_3d(sizex,sizey,sizez,Derivative_SGM13tx,Derivative_SGM13tx_out,MPI_COMM_WORLD,FFTW_BACKWARD,FFTW_WISDOM_ONLY | FFTW_ESTIMATE);
    plan_backward23tx = fftw_mpi_plan_dft_3d(sizex,sizey,sizez,Derivative_SGM23tx,Derivative_SGM23tx_out,MPI_COMM_WORLD,FFTW_BACKWARD,FFTW_WISDOM_ONLY | FFTW_ESTIMATE);
    plan_backward12ty = fftw_mpi_plan_dft_3d(sizex,sizey,sizez,Derivative_SGM12ty,Derivative_SGM12ty_out,MPI_COMM_WORLD,FFTW_BACKWARD,FFTW_WISDOM_ONLY | FFTW_ESTIMATE);
    plan_backward13ty = fftw_mpi_plan_dft_3d(sizex,sizey,sizez,Derivative_SGM13ty,Derivative_SGM13ty_out,MPI_COMM_WORLD,FFTW_BACKWARD,FFTW_WISDOM_ONLY | FFTW_ESTIMATE);
    plan_backward23ty = fftw_mpi_plan_dft_3d(sizex,sizey,sizez,Derivative_SGM23ty,Derivative_SGM23ty_out,MPI_COMM_WORLD,FFTW_BACKWARD,FFTW_WISDOM_ONLY | FFTW_ESTIMATE);
    plan_backward12tz = fftw_mpi_plan_dft_3d(sizex,sizey,sizez,Derivative_SGM12tz,Derivative_SGM12tz_out,MPI_COMM_WORLD,FFTW_BACKWARD,FFTW_WISDOM_ONLY | FFTW_ESTIMATE);
    plan_backward13tz = fftw_mpi_plan_dft_3d(sizex,sizey,sizez,Derivative_SGM13tz,Derivative_SGM13tz_out,MPI_COMM_WORLD,FFTW_BACKWARD,FFTW_WISDOM_ONLY | FFTW_ESTIMATE);
    plan_backward23tz = fftw_mpi_plan_dft_3d(sizex,sizey,sizez,Derivative_SGM23tz,Derivative_SGM23tz_out,MPI_COMM_WORLD,FFTW_BACKWARD,FFTW_WISDOM_ONLY | FFTW_ESTIMATE);
    ...
    fftw_execute(plan_backward11tt);
    fftw_execute(plan_backward22tt);
    fftw_execute(plan_backward33tt);
    fftw_execute(plan_backward11tx);
    fftw_execute(plan_backward22tx);
    fftw_execute(plan_backward33tx);
    fftw_execute(plan_backward11ty);
    fftw_execute(plan_backward22ty);
    fftw_execute(plan_backward33ty);
    fftw_execute(plan_backward11tz);
    fftw_execute(plan_backward22tz);
    fftw_execute(plan_backward33tz);
    fftw_execute(plan_backward12tt);
    fftw_execute(plan_backward13tt);
    fftw_execute(plan_backward23tt);
    fftw_execute(plan_backward12tx);
    fftw_execute(plan_backward13tx);
    fftw_execute(plan_backward23tx);
    fftw_execute(plan_backward12ty);
    fftw_execute(plan_backward13ty);
    fftw_execute(plan_backward23ty);
    fftw_execute(plan_backward12tz);
    fftw_execute(plan_backward13tz);
    fftw_execute(plan_backward23tz);
    ...
    for(k = 0; k < local_n0; k++) 
    {
        for(j = 0; j < sizey; j++) 
        {
            for(i = 0; i < sizex; i++) 
            {
				...
				temp_phi11tt[ i + j*sizex + k*sizex*sizey ] = creal(Derivative_SGM11tt_out[i + j*sizex + k*sizex*sizey]) / (sizex*sizey*sizez);
				temp_phi22tt[ i + j*sizex + k*sizex*sizey ] = creal(Derivative_SGM22tt_out[i + j*sizex + k*sizex*sizey]) / (sizex*sizey*sizez);
				temp_phi33tt[ i + j*sizex + k*sizex*sizey ] = creal(Derivative_SGM33tt_out[i + j*sizex + k*sizex*sizey]) / (sizex*sizey*sizez);
				temp_phi11tx[ i + j*sizex + k*sizex*sizey ] = creal(Derivative_SGM11tx_out[i + j*sizex + k*sizex*sizey]) / (sizex*sizey*sizez);
				temp_phi22tx[ i + j*sizex + k*sizex*sizey ] = creal(Derivative_SGM22tx_out[i + j*sizex + k*sizex*sizey]) / (sizex*sizey*sizez);
				temp_phi33tx[ i + j*sizex + k*sizex*sizey ] = creal(Derivative_SGM33tx_out[i + j*sizex + k*sizex*sizey]) / (sizex*sizey*sizez);
				temp_phi11ty[ i + j*sizex + k*sizex*sizey ] = creal(Derivative_SGM11ty_out[i + j*sizex + k*sizex*sizey]) / (sizex*sizey*sizez);
				temp_phi22ty[ i + j*sizex + k*sizex*sizey ] = creal(Derivative_SGM22ty_out[i + j*sizex + k*sizex*sizey]) / (sizex*sizey*sizez);
				temp_phi33ty[ i + j*sizex + k*sizex*sizey ] = creal(Derivative_SGM33ty_out[i + j*sizex + k*sizex*sizey]) / (sizex*sizey*sizez);
				temp_phi11tz[ i + j*sizex + k*sizex*sizey ] = creal(Derivative_SGM11tz_out[i + j*sizex + k*sizex*sizey]) / (sizex*sizey*sizez);
				temp_phi22tz[ i + j*sizex + k*sizex*sizey ] = creal(Derivative_SGM22tz_out[i + j*sizex + k*sizex*sizey]) / (sizex*sizey*sizez);
				temp_phi33tz[ i + j*sizex + k*sizex*sizey ] = creal(Derivative_SGM33tz_out[i + j*sizex + k*sizex*sizey]) / (sizex*sizey*sizez);
				temp_phi12tt[ i + j*sizex + k*sizex*sizey ] = creal(Derivative_SGM12tt_out[i + j*sizex + k*sizex*sizey]) / (sizex*sizey*sizez);
				temp_phi13tt[ i + j*sizex + k*sizex*sizey ] = creal(Derivative_SGM13tt_out[i + j*sizex + k*sizex*sizey]) / (sizex*sizey*sizez);
				temp_phi23tt[ i + j*sizex + k*sizex*sizey ] = creal(Derivative_SGM23tt_out[i + j*sizex + k*sizex*sizey]) / (sizex*sizey*sizez);
				temp_phi12tx[ i + j*sizex + k*sizex*sizey ] = creal(Derivative_SGM12tx_out[i + j*sizex + k*sizex*sizey]) / (sizex*sizey*sizez);
				temp_phi13tx[ i + j*sizex + k*sizex*sizey ] = creal(Derivative_SGM13tx_out[i + j*sizex + k*sizex*sizey]) / (sizex*sizey*sizez);
				temp_phi23tx[ i + j*sizex + k*sizex*sizey ] = creal(Derivative_SGM23tx_out[i + j*sizex + k*sizex*sizey]) / (sizex*sizey*sizez);
				temp_phi12ty[ i + j*sizex + k*sizex*sizey ] = creal(Derivative_SGM12ty_out[i + j*sizex + k*sizex*sizey]) / (sizex*sizey*sizez);
				temp_phi13ty[ i + j*sizex + k*sizex*sizey ] = creal(Derivative_SGM13ty_out[i + j*sizex + k*sizex*sizey]) / (sizex*sizey*sizez);
				temp_phi23ty[ i + j*sizex + k*sizex*sizey ] = creal(Derivative_SGM23ty_out[i + j*sizex + k*sizex*sizey]) / (sizex*sizey*sizez);
				temp_phi12tz[ i + j*sizex + k*sizex*sizey ] = creal(Derivative_SGM12tz_out[i + j*sizex + k*sizex*sizey]) / (sizex*sizey*sizez);
				temp_phi13tz[ i + j*sizex + k*sizex*sizey ] = creal(Derivative_SGM13tz_out[i + j*sizex + k*sizex*sizey]) / (sizex*sizey*sizez);
				temp_phi23tz[ i + j*sizex + k*sizex*sizey ] = creal(Derivative_SGM23tz_out[i + j*sizex + k*sizex*sizey]) / (sizex*sizey*sizez);
    ...
    fftw_destroy_plan(plan_backward11tt);
    fftw_destroy_plan(plan_backward22tt);
    fftw_destroy_plan(plan_backward33tt);
    fftw_destroy_plan(plan_backward11tx);
    fftw_destroy_plan(plan_backward22tx);
    fftw_destroy_plan(plan_backward33tx);
    fftw_destroy_plan(plan_backward11ty);
    fftw_destroy_plan(plan_backward22ty);
    fftw_destroy_plan(plan_backward33ty);
    fftw_destroy_plan(plan_backward11tz);
    fftw_destroy_plan(plan_backward22tz);
    fftw_destroy_plan(plan_backward33tz);
    fftw_destroy_plan(plan_backward12tt);
    fftw_destroy_plan(plan_backward13tt);
    fftw_destroy_plan(plan_backward23tt);
    fftw_destroy_plan(plan_backward12tx);
    fftw_destroy_plan(plan_backward13tx);
    fftw_destroy_plan(plan_backward23tx);
    fftw_destroy_plan(plan_backward12ty);
    fftw_destroy_plan(plan_backward13ty);
    fftw_destroy_plan(plan_backward23ty);
    fftw_destroy_plan(plan_backward12tz);
    fftw_destroy_plan(plan_backward13tz);
    fftw_destroy_plan(plan_backward23tz);
    ...
    fftw_free(Derivative_SGM11tt);
    fftw_free(Derivative_SGM22tt);
    fftw_free(Derivative_SGM33tt);
    fftw_free(Derivative_SGM11tx);
    fftw_free(Derivative_SGM22tx);
    fftw_free(Derivative_SGM33tx);
    fftw_free(Derivative_SGM11ty);
    fftw_free(Derivative_SGM22ty);
    fftw_free(Derivative_SGM33ty);
    fftw_free(Derivative_SGM11tz);
    fftw_free(Derivative_SGM22tz);
    fftw_free(Derivative_SGM33tz);
    fftw_free(Derivative_SGM12tt);
    fftw_free(Derivative_SGM13tt);
    fftw_free(Derivative_SGM23tt);
    fftw_free(Derivative_SGM12tx);
    fftw_free(Derivative_SGM13tx);
    fftw_free(Derivative_SGM23tx);
    fftw_free(Derivative_SGM12ty);
    fftw_free(Derivative_SGM13ty);
    fftw_free(Derivative_SGM23ty);
    fftw_free(Derivative_SGM13tz);
    fftw_free(Derivative_SGM12tz);
    fftw_free(Derivative_SGM23tz);
    ...
    fftw_free(Derivative_SGM11tt_out);
    fftw_free(Derivative_SGM22tt_out);
    fftw_free(Derivative_SGM33tt_out);
    fftw_free(Derivative_SGM11tx_out);
    fftw_free(Derivative_SGM22tx_out);
    fftw_free(Derivative_SGM33tx_out);
    fftw_free(Derivative_SGM11ty_out);
    fftw_free(Derivative_SGM22ty_out);
    fftw_free(Derivative_SGM33ty_out);
    fftw_free(Derivative_SGM11tz_out);
    fftw_free(Derivative_SGM22tz_out);
    fftw_free(Derivative_SGM33tz_out);
    fftw_free(Derivative_SGM12tt_out);
    fftw_free(Derivative_SGM13tt_out);
    fftw_free(Derivative_SGM23tt_out);
    fftw_free(Derivative_SGM12tx_out);
    fftw_free(Derivative_SGM13tx_out);
    fftw_free(Derivative_SGM23tx_out);
    fftw_free(Derivative_SGM12ty_out);
    fftw_free(Derivative_SGM13ty_out);
    fftw_free(Derivative_SGM23ty_out);
    fftw_free(Derivative_SGM13tz_out);
    fftw_free(Derivative_SGM12tz_out);
    fftw_free(Derivative_SGM23tz_out);
...
void SpecDeriv_Write_Tensor2_4D( CCTK_ARGUMENTS, CCTK_REAL *****tensor2_4D )
{
    ...
    for(k=0; k < kstart; k++)
	{
		for(j=0; j < jstart; j++)
		{
            ...
            {
            	index = CCTK_GFINDEX3D( cctkGH, i, j, k );
                tensor2_4D[0][1][0][0][index] = 0.0;
                tensor2_4D[0][2][0][0][index] = 0.0;
                tensor2_4D[0][3][0][0][index] = 0.0;
                tensor2_4D[0][1][0][1][index] = 0.0;
                tensor2_4D[0][2][0][1][index] = 0.0;
                tensor2_4D[0][3][0][1][index] = 0.0;
                tensor2_4D[0][1][0][2][index] = 0.0;
                tensor2_4D[0][2][0][2][index] = 0.0;
                tensor2_4D[0][3][0][2][index] = 0.0;
                tensor2_4D[0][1][0][3][index] = 0.0;
                tensor2_4D[0][2][0][3][index] = 0.0;
                tensor2_4D[0][3][0][3][index] = 0.0;
                
                tensor2_4D[0][1][1][0][index] = 0.0;
                tensor2_4D[0][2][1][0][index] = 0.0;
                tensor2_4D[0][3][1][0][index] = 0.0;
                tensor2_4D[0][1][2][0][index] = 0.0;
                tensor2_4D[0][2][2][0][index] = 0.0;
                tensor2_4D[0][3][2][0][index] = 0.0;
                tensor2_4D[0][1][3][0][index] = 0.0;
                tensor2_4D[0][2][3][0][index] = 0.0;
                tensor2_4D[0][3][3][0][index] = 0.0;
                
                tensor2_4D[1][0][0][0][index] = 0.0;
                tensor2_4D[2][0][0][0][index] = 0.0;
                tensor2_4D[3][0][0][0][index] = 0.0;
                tensor2_4D[1][0][0][1][index] = 0.0;
                tensor2_4D[2][0][0][1][index] = 0.0;
                tensor2_4D[3][0][0][1][index] = 0.0;
                tensor2_4D[1][0][0][2][index] = 0.0;
                tensor2_4D[2][0][0][2][index] = 0.0;
                tensor2_4D[3][0][0][2][index] = 0.0;
                tensor2_4D[1][0][0][3][index] = 0.0;
                tensor2_4D[2][0][0][3][index] = 0.0;
                tensor2_4D[3][0][0][3][index] = 0.0;
                
                tensor2_4D[1][0][1][0][index] = 0.0;
                tensor2_4D[2][0][1][0][index] = 0.0;
                tensor2_4D[3][0][1][0][index] = 0.0;
                tensor2_4D[1][0][2][0][index] = 0.0;
                tensor2_4D[2][0][2][0][index] = 0.0;
                tensor2_4D[3][0][2][0][index] = 0.0;
                tensor2_4D[1][0][3][0][index] = 0.0;
                tensor2_4D[2][0][3][0][index] = 0.0;
                tensor2_4D[3][0][3][0][index] = 0.0;
                
                tensor2_4D[0][1][1][1][index] = 0.0;
                tensor2_4D[0][2][1][1][index] = 0.0;
                tensor2_4D[0][3][1][1][index] = 0.0;
                tensor2_4D[0][1][2][2][index] = 0.0;
                tensor2_4D[0][2][2][2][index] = 0.0;
                tensor2_4D[0][3][2][2][index] = 0.0;
                tensor2_4D[0][1][3][3][index] = 0.0;
                tensor2_4D[0][2][3][3][index] = 0.0;
                tensor2_4D[0][3][3][3][index] = 0.0;
                
                tensor2_4D[1][0][1][1][index] = 0.0;
                tensor2_4D[2][0][1][1][index] = 0.0;
                tensor2_4D[3][0][1][1][index] = 0.0;
                tensor2_4D[1][0][2][2][index] = 0.0;
                tensor2_4D[2][0][2][2][index] = 0.0;
                tensor2_4D[3][0][2][2][index] = 0.0;
                tensor2_4D[1][0][3][3][index] = 0.0;
                tensor2_4D[2][0][3][3][index] = 0.0;
                tensor2_4D[3][0][3][3][index] = 0.0;
                
                tensor2_4D[0][1][1][2][index] = 0.0;
                tensor2_4D[0][2][1][2][index] = 0.0;
                tensor2_4D[0][3][1][2][index] = 0.0;
                tensor2_4D[0][1][1][3][index] = 0.0;
                tensor2_4D[0][2][1][3][index] = 0.0;
                tensor2_4D[0][3][1][3][index] = 0.0;
                tensor2_4D[0][1][2][3][index] = 0.0;
                tensor2_4D[0][2][2][3][index] = 0.0;
                tensor2_4D[0][3][2][3][index] = 0.0;
                
                tensor2_4D[0][1][2][1][index] = 0.0;
                tensor2_4D[0][2][2][1][index] = 0.0;
                tensor2_4D[0][3][2][1][index] = 0.0;
                tensor2_4D[0][1][3][1][index] = 0.0;
                tensor2_4D[0][2][3][1][index] = 0.0;
                tensor2_4D[0][3][3][1][index] = 0.0;
                tensor2_4D[0][1][3][2][index] = 0.0;
                tensor2_4D[0][2][3][2][index] = 0.0;
                tensor2_4D[0][3][3][2][index] = 0.0;
                
                tensor2_4D[1][0][1][2][index] = 0.0;
                tensor2_4D[2][0][1][2][index] = 0.0;
                tensor2_4D[3][0][1][2][index] = 0.0;
                tensor2_4D[1][0][1][3][index] = 0.0;
                tensor2_4D[2][0][1][3][index] = 0.0;
                tensor2_4D[3][0][1][3][index] = 0.0;
                tensor2_4D[1][0][2][3][index] = 0.0;
                tensor2_4D[2][0][2][3][index] = 0.0;
                tensor2_4D[3][0][2][3][index] = 0.0;
                
                tensor2_4D[1][0][2][1][index] = 0.0;
                tensor2_4D[2][0][2][1][index] = 0.0;
                tensor2_4D[3][0][2][1][index] = 0.0;
                tensor2_4D[1][0][3][1][index] = 0.0;
                tensor2_4D[2][0][3][1][index] = 0.0;
                tensor2_4D[3][0][3][1][index] = 0.0;
                tensor2_4D[1][0][3][2][index] = 0.0;
                tensor2_4D[2][0][3][2][index] = 0.0;
                tensor2_4D[3][0][3][2][index] = 0.0;
                
                tensor2_4D[1][1][0][0][index] = 0.0;
                tensor2_4D[2][2][0][0][index] = 0.0;
                tensor2_4D[3][3][0][0][index] = 0.0;
                tensor2_4D[1][1][0][1][index] = 0.0;
                tensor2_4D[2][2][0][1][index] = 0.0;
                tensor2_4D[3][3][0][1][index] = 0.0;
                tensor2_4D[1][1][0][2][index] = 0.0;
                tensor2_4D[2][2][0][2][index] = 0.0;
                tensor2_4D[3][3][0][2][index] = 0.0;
                tensor2_4D[1][1][0][3][index] = 0.0;
                tensor2_4D[2][2][0][3][index] = 0.0;
                tensor2_4D[3][3][0][3][index] = 0.0;
                
                tensor2_4D[1][1][1][0][index] = 0.0;
                tensor2_4D[2][2][1][0][index] = 0.0;
                tensor2_4D[3][3][1][0][index] = 0.0;
                tensor2_4D[1][1][2][0][index] = 0.0;
                tensor2_4D[2][2][2][0][index] = 0.0;
                tensor2_4D[3][3][2][0][index] = 0.0;
                tensor2_4D[1][1][3][0][index] = 0.0;
                tensor2_4D[2][2][3][0][index] = 0.0;
                tensor2_4D[3][3][3][0][index] = 0.0;
                
                tensor2_4D[1][2][0][0][index] = 0.0;
                tensor2_4D[1][3][0][0][index] = 0.0;
                tensor2_4D[2][3][0][0][index] = 0.0;
                tensor2_4D[1][2][0][1][index] = 0.0;
                tensor2_4D[1][3][0][1][index] = 0.0;
                tensor2_4D[2][3][0][1][index] = 0.0;
                tensor2_4D[1][2][0][2][index] = 0.0;
                tensor2_4D[1][3][0][2][index] = 0.0;
                tensor2_4D[2][3][0][2][index] = 0.0;
                tensor2_4D[1][2][0][3][index] = 0.0;
                tensor2_4D[1][3][0][3][index] = 0.0;
                tensor2_4D[2][3][0][3][index] = 0.0;
                
                tensor2_4D[2][1][0][0][index] = 0.0;
                tensor2_4D[3][1][0][0][index] = 0.0;
                tensor2_4D[3][2][0][0][index] = 0.0;
                tensor2_4D[2][1][0][1][index] = 0.0;
                tensor2_4D[3][1][0][1][index] = 0.0;
                tensor2_4D[3][2][0][1][index] = 0.0;
                tensor2_4D[2][1][0][2][index] = 0.0;
                tensor2_4D[3][1][0][2][index] = 0.0;
                tensor2_4D[3][2][0][2][index] = 0.0;
                tensor2_4D[2][1][0][3][index] = 0.0;
                tensor2_4D[3][1][0][3][index] = 0.0;
                tensor2_4D[3][2][0][3][index] = 0.0;
                
                tensor2_4D[1][2][1][0][index] = 0.0;
                tensor2_4D[1][3][1][0][index] = 0.0;
                tensor2_4D[2][3][1][0][index] = 0.0;
                tensor2_4D[1][2][2][0][index] = 0.0;
                tensor2_4D[1][3][2][0][index] = 0.0;
                tensor2_4D[2][3][2][0][index] = 0.0;
                tensor2_4D[1][2][3][0][index] = 0.0;
                tensor2_4D[1][3][3][0][index] = 0.0;
                tensor2_4D[2][3][3][0][index] = 0.0;
                
                tensor2_4D[2][1][1][0][index] = 0.0;
                tensor2_4D[3][1][1][0][index] = 0.0;
                tensor2_4D[3][2][1][0][index] = 0.0;
                tensor2_4D[2][1][2][0][index] = 0.0;
                tensor2_4D[3][1][2][0][index] = 0.0;
                tensor2_4D[3][2][2][0][index] = 0.0;
                tensor2_4D[2][1][3][0][index] = 0.0;
                tensor2_4D[3][1][3][0][index] = 0.0;
                tensor2_4D[3][2][3][0][index] = 0.0;
                
                tensor2_4D[1][1][1][1][index] = 0.0;
                tensor2_4D[2][2][1][1][index] = 0.0;
                tensor2_4D[3][3][1][1][index] = 0.0;
                tensor2_4D[1][1][2][2][index] = 0.0;
                tensor2_4D[2][2][2][2][index] = 0.0;
                tensor2_4D[3][3][2][2][index] = 0.0;
                tensor2_4D[1][1][3][3][index] = 0.0;
                tensor2_4D[2][2][3][3][index] = 0.0;
                tensor2_4D[3][3][3][3][index] = 0.0;
                
                tensor2_4D[1][2][1][1][index] = 0.0;
                tensor2_4D[1][3][1][1][index] = 0.0;
                tensor2_4D[2][3][1][1][index] = 0.0;
                tensor2_4D[1][2][2][2][index] = 0.0;
                tensor2_4D[1][3][2][2][index] = 0.0;
                tensor2_4D[2][3][2][2][index] = 0.0;
                tensor2_4D[1][2][3][3][index] = 0.0;
                tensor2_4D[1][3][3][3][index] = 0.0;
                tensor2_4D[2][3][3][3][index] = 0.0;
                
                tensor2_4D[2][1][1][1][index] = 0.0;
                tensor2_4D[3][1][1][1][index] = 0.0;
                tensor2_4D[3][2][1][1][index] = 0.0;
                tensor2_4D[2][1][2][2][index] = 0.0;
                tensor2_4D[3][1][2][2][index] = 0.0;
                tensor2_4D[3][2][2][2][index] = 0.0;
                tensor2_4D[2][1][3][3][index] = 0.0;
                tensor2_4D[3][1][3][3][index] = 0.0;
                tensor2_4D[3][2][3][3][index] = 0.0;
                
                tensor2_4D[1][1][1][2][index] = 0.0;
                tensor2_4D[2][2][1][2][index] = 0.0;
                tensor2_4D[3][3][1][2][index] = 0.0;
                tensor2_4D[1][1][1][3][index] = 0.0;
                tensor2_4D[2][2][1][3][index] = 0.0;
                tensor2_4D[3][3][1][3][index] = 0.0;
                tensor2_4D[1][1][2][3][index] = 0.0;
                tensor2_4D[2][2][2][3][index] = 0.0;
                tensor2_4D[3][3][2][3][index] = 0.0;
                
                tensor2_4D[1][1][2][1][index] = 0.0;
                tensor2_4D[2][2][2][1][index] = 0.0;
                tensor2_4D[3][3][2][1][index] = 0.0;
                tensor2_4D[1][1][3][1][index] = 0.0;
                tensor2_4D[2][2][3][1][index] = 0.0;
                tensor2_4D[3][3][3][1][index] = 0.0;
                tensor2_4D[1][1][3][2][index] = 0.0;
                tensor2_4D[2][2][3][2][index] = 0.0;
                tensor2_4D[3][3][3][2][index] = 0.0;
                
                tensor2_4D[1][2][1][2][index] = 0.0;
                tensor2_4D[1][3][1][2][index] = 0.0;
                tensor2_4D[2][3][1][2][index] = 0.0;
                tensor2_4D[1][2][1][3][index] = 0.0;
                tensor2_4D[1][3][1][3][index] = 0.0;
                tensor2_4D[2][3][1][3][index] = 0.0;
                tensor2_4D[1][2][2][3][index] = 0.0;
                tensor2_4D[1][3][2][3][index] = 0.0;
                tensor2_4D[2][3][2][3][index] = 0.0;
                
                tensor2_4D[1][2][2][1][index] = 0.0;
                tensor2_4D[1][3][2][1][index] = 0.0;
                tensor2_4D[2][3][2][1][index] = 0.0;
                tensor2_4D[1][2][3][1][index] = 0.0;
                tensor2_4D[1][3][3][1][index] = 0.0;
                tensor2_4D[2][3][3][1][index] = 0.0;
                tensor2_4D[1][2][3][2][index] = 0.0;
                tensor2_4D[1][3][3][2][index] = 0.0;
                tensor2_4D[2][3][3][2][index] = 0.0;
                
                tensor2_4D[2][1][1][2][index] = 0.0;
                tensor2_4D[3][1][1][2][index] = 0.0;
                tensor2_4D[3][2][1][2][index] = 0.0;
                tensor2_4D[2][1][1][3][index] = 0.0;
                tensor2_4D[3][1][1][3][index] = 0.0;
                tensor2_4D[3][2][1][3][index] = 0.0;
                tensor2_4D[2][1][2][3][index] = 0.0;
                tensor2_4D[3][1][2][3][index] = 0.0;
                tensor2_4D[3][2][2][3][index] = 0.0;
                
                tensor2_4D[2][1][2][1][index] = 0.0;
                tensor2_4D[3][1][2][1][index] = 0.0;
                tensor2_4D[3][2][2][1][index] = 0.0;
                tensor2_4D[2][1][3][1][index] = 0.0;
                tensor2_4D[3][1][3][1][index] = 0.0;
                tensor2_4D[3][2][3][1][index] = 0.0;
                tensor2_4D[2][1][3][2][index] = 0.0;
                tensor2_4D[3][1][3][2][index] = 0.0;
                tensor2_4D[3][2][3][2][index] = 0.0;
            }
        }
    }
