...
void SpecDeriv_Tensor_Derivative2_4D_FD4( CCTK_ARGUMENTS, CCTK_REAL *****tensor2_4D );
        ...
        for (m = 1; m < 4; m++) {
            for (n = 0; n < 4; n++) {
                for (p = 0; p < 4; p++) {
                   ...
                   tensor2_4D[0][m][n][p][index] = (tensor2_4D[0][0][n][p][vv_2index] - 
                                                    8.0*tensor2_4D[0][0][n][p][vvindex] + 
                                                    8.0*tensor2_4D[0][0][n][p][uuindex] - 
                                                     tensor2_4D[0][0][n][p][uu_2index]) / 
                                                     (12.0*CCTK_DELTA_SPACE(m-1));

                   tensor2_4D[m][0][n][p][index] = tensor2_4D[0][m][n][p][index];      
                   ...
                   for (q = 1; q < 4; q++) {
                      ...
                      tensor2_4D[m][q][n][p][index] = ( tensor2_4D[0][0][n][p][v2v2index] - 
                                                       8.0 * tensor2_4D[0][0][n][p][v2vindex] + 
                                                       8.0 * tensor2_4D[0][0][n][p][v2uindex] - 
                                                       tensor2_4D[0][0][n][p][v2u2index] - 
                                                       8.0 * tensor2_4D[0][0][n][p][vv2index] + 
                                                       64.0 * tensor2_4D[0][0][n][p][vvindex] - 
                                                       64.0 * tensor2_4D[0][0][n][p][vuindex] + 
                                                       8.0 * tensor2_4D[0][0][n][p][vu2index] + 
                                                       8.0 * tensor2_4D[0][0][n][p][uv2index] - 
                                                       64.0 * tensor2_4D[0][0][n][p][uvindex] + 
                                                       64.0 * tensor2_4D[0][0][n][p][uuindex] - 
                                                       8.0 * tensor2_4D[0][0][n][p][uu2index] - 
                                                       tensor2_4D[0][0][n][p][u2v2index] + 
                                                       8.0 * tensor2_4D[0][0][n][p][u2vindex] - 
                                                       8.0 * tensor2_4D[0][0][n][p][u2uindex] + 
                                                       tensor2_4D[0][0][n][p][u2u2index] ) * 
                   ...
                   tensor2_4D[m][m][n][p][index] = ( -1.0 * tensor2_4D[0][0][n][p][vv_2index] + 
                                                    16.0 * tensor2_4D[0][0][n][p][vvindex] - 
                                                    30.0 * tensor2_4D[0][0][n][p][index] + 
                                                    16.0 * tensor2_4D[0][0][n][p][uuindex] - 
                                                    tensor2_4D[0][0][n][p][uu_2index] ) / 
