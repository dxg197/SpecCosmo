    ...
    for(k=kstart; k < kend; k++)
	{
        ...
        for (m = 1; m < 4; m++) {
            for (n = 1; n < 4; n++) {
                ...
                vector2[0][m][n][index] = (vector2[0][0][n][vv_2index] - 8.0*vector2[0][0][n][vvindex] + 
                                           8.0*vector2[0][0][n][uuindex] - vector2[0][0][n][uu_2index]) / 
                ...
                for (p = 1; p < 4; p++) {
                    ...
                    u2vindex = u2v_index[m][p];
                    v2uindex = v2u_index[m][p];
                    uv2index = uv2_index[m][p];
                    vu2index = vu2_index[m][p];
                    u2v2index = u2v2_index[m][p];
                    v2u2index = v2u2_index[m][p];
                    u2uindex = u2u_index[m][p];
                    v2vindex = v2v_index[m][p];
                    uu2index = uu2_index[m][p];
                    vv2index = vv2_index[m][p];
                    u2u2index = u2u2_index[m][p];
                    v2v2index = v2v2_index[m][p];

                    vector2[m][p][n][index] = (vector2[0][0][n][v2v2index] - 8.0 * vector2[0][0][n][v2vindex] + 
                                               8.0 * vector2[0][0][n][v2uindex] - vector2[0][0][n][v2u2index] - 
                                               8.0 * vector2[0][0][n][vv2index] + 64.0 * vector2[0][0][n][vvindex] - 
                                               64.0 * vector2[0][0][n][vuindex] + 8.0 * vector2[0][0][n][vu2index] + 
                                               8.0 * vector2[0][0][n][uv2index] - 64.0 * vector2[0][0][n][uvindex] + 
                                               64.0 * vector2[0][0][n][uuindex] - 8.0 * vector2[0][0][n][uu2index] - 
                                               vector2[0][0][n][u2v2index] + 8.0 * vector2[0][0][n][u2vindex] - 
                                               8.0 * vector2[0][0][n][u2uindex] + vector2[0][0][n][u2u2index] ) * 
                                               ( 1.0 / (144.0 * CCTK_DELTA_SPACE(m-1) * CCTK_DELTA_SPACE(p-1) ) );
                      }
                   } 
                   ...
                   vector2[m][m][n][index] = (-1.0 * vector2[0][0][n][vv_2index] + 16.0 * vector2[0][0][n][vvindex] - 
                                              30.0 * vector2[0][0][n][index] + 16.0 * vector2[0][0][n][uuindex] - 
                                              vector2[0][0][n][uu_2index] ) / ( 12.0 * CCTK_DELTA_SPACE(m-1) * 
