...
void SpecDeriv_Write_Tensor_1d( CCTK_ARGUMENTS, CCTK_REAL ****tensor );
void SpecDeriv_SpecGalMethod_Tensor_1d( CCTK_ARGUMENTS );
...
void SpecDeriv_Tensor_Derivative_1d( CCTK_ARGUMENTS, CCTK_REAL ****tensor )
{
	...
	SpecDeriv_SpecGalMethod_Tensor_1d( CCTK_PASS_CTOC );
	SpecDeriv_Write_Tensor_1d( CCTK_PASS_CTOC, tensor );
}
    ...
    for(k=kstart; k < kend; k++)
	{
		for(j=jstart; j < jend; j++)
		{
			for(i=istart; i < iend; i++)
            {
                ...
                tensor[1][2][1][index] = temp_phi1xy[ index ];
                tensor[2][2][1][index] = temp_phi2xy[ index ];
                tensor[3][2][1][index] = temp_phi3xy[ index ];
                tensor[1][3][1][index] = temp_phi1xz[ index ];
                tensor[2][3][1][index] = temp_phi2xz[ index ];
                tensor[3][3][1][index] = temp_phi3xz[ index ];
                tensor[1][3][2][index] = temp_phi1yz[ index ];
                tensor[2][3][2][index] = temp_phi2yz[ index ];
                tensor[3][3][2][index] = temp_phi3yz[ index ];
			}
		}
	}
}
