...
void SpecDeriv_Tensor_Derivative2_4D_FD( CCTK_ARGUMENTS, CCTK_REAL *****tensor2_4D );
		...
		for(j=jstart; j < jend; j++)
		{
			for(i=istart; i < iend; i++)
            {
                ...
                for (m = 1; m < 4; m++) {
                   ...
                   tensor2_4D[0][m][n][p][index] = (tensor2_4D[0][0][n][p][uuindex] - tensor2_4D[0][0][n][p][vvindex]) / 
                   ...
                   for (q = 1; q < 4; q++) {
                      ...
                      tensor2_4D[m][q][n][p][index] = (tensor2_4D[0][0][n][p][uuindex] - tensor2_4D[0][0][n][p][uvindex] -
                                                       tensor2_4D[0][0][n][p][vuindex] + tensor2_4D[0][0][n][p][vvindex]) / 
                                                                        (4.0*CCTK_DELTA_SPACE(m-1)*CCTK_DELTA_SPACE(q-1));
                      }
                   } 
                   uuindex = uu_index[m][m];
                   vvindex = vv_index[m][m];
                   tensor2_4D[m][m][n][p][index] = (tensor2_4D[0][0][n][p][uuindex] - 2.0*tensor2_4D[0][0][n][p][index] +
                                                    tensor2_4D[0][0][n][p][vvindex]) / (CCTK_DELTA_SPACE(m-1)*CCTK_DELTA_SPACE(m-1));
                      }
                   }         
                }                                             
			}
