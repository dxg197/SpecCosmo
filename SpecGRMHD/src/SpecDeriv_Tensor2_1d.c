...
void SpecDeriv_Write_Tensor2_1d( CCTK_ARGUMENTS, CCTK_REAL *****tensor2 );
void SpecDeriv_SpecGalMethod_Tensor2_1d( CCTK_ARGUMENTS );
...
void SpecDeriv_Tensor_Derivative2_1d( CCTK_ARGUMENTS, CCTK_REAL *****tensor2 )
{
	...
	SpecDeriv_SpecGalMethod_Tensor2_1d( CCTK_PASS_CTOC );
	SpecDeriv_Write_Tensor2_1d( CCTK_PASS_CTOC, tensor2 );
}
