...
void SpecDeriv_Write_Scalar_1d( CCTK_ARGUMENTS, CCTK_REAL **scalar );
void SpecDeriv_SpecGalMethod_Scalar_1d( CCTK_ARGUMENTS );
...
void SpecDeriv_Scalar_Derivative_1d( CCTK_ARGUMENTS, CCTK_REAL **scalar )
{
	...
	SpecDeriv_SpecGalMethod_Scalar_1d( CCTK_PASS_CTOC );
	SpecDeriv_Write_Scalar_1d( CCTK_PASS_CTOC, scalar );
}
