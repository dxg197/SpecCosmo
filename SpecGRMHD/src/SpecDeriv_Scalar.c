...
void SpecDeriv_Write_Scalar( CCTK_ARGUMENTS, CCTK_REAL **scalar );
void SpecDeriv_SpecGalMethod_Scalar( CCTK_ARGUMENTS );
...
void SpecDeriv_Scalar_Derivative( CCTK_ARGUMENTS, CCTK_REAL **scalar )
{
	...
	SpecDeriv_SpecGalMethod_Scalar( CCTK_PASS_CTOC );
	SpecDeriv_Write_Scalar( CCTK_PASS_CTOC, scalar );
}
