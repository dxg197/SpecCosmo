...
void SpecDeriv_Tensor_Derivative_4D_1d( CCTK_ARGUMENTS, CCTK_REAL ****tensor_4D );
void SpecDeriv_Write_Tensor_4D_1d( CCTK_ARGUMENTS, CCTK_REAL ****tensor_4D );
void SpecDeriv_SpecGalMethod_Tensor_4D_1d( CCTK_ARGUMENTS );
...
void SpecDeriv_Tensor_Derivative_4D_1d( CCTK_ARGUMENTS, CCTK_REAL ****tensor_4D )
{
	...
	SpecDeriv_SpecGalMethod_Tensor_4D_1d( CCTK_PASS_CTOC );
	SpecDeriv_Write_Tensor_4D_1d( CCTK_PASS_CTOC, tensor_4D );
}
